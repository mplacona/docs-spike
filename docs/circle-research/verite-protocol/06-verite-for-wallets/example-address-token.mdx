...
slug: "example-address-token"
hidden: false
createdAt: "2023-10-24T01:32:18.006Z"
updatedAt: "2023-10-25T23:59:19.394Z"
---
...
In many use-cases, a token actually contains multiple credential/claim types, each expressed as a distinct (and fully-formed) `credentialSubject` object with a `type` property in this list. The semantics for these types is explained in [this blog post](doc:crossfunctionality).
