...
slug: "tutorial-creating-a-registry-contract-in-solidity"
excerpt: "Creating a Registry Contract in Solidity"
hidden: false
createdAt: "2023-10-24T01:32:18.012Z"
updatedAt: "2023-10-25T23:59:19.378Z"
sidebar_position: 7
---
When using the [smart contract pattern](doc:smart-contract-patterns) for verifications, you can use any blockchain you would like. For the sake of this guide, we will focus on [Solidity](https://docs.soliditylang.org/en/v0.8.11/), which is the programming language for the Ethereum Virtual Machine.
...
Finally, we will import the `EIP712` library. This is the most important library in our contract since it is foundational to how we will verify credentials. For more on this, be sure to reference the [Smart Contract Patterns section](doc:smart-contract-patterns).
